...
// WiFi
const char *WIFI_SSID = "JoyFull Wifi";
const char *WIFI_PASSWORD = "newstalgia1";

// Demeter Server
const char *DEMETER_SERVER =
    "http://192.168.171.248:5000";    // Change to your server IP
const int REPORT_INTERVAL_MS = 30000; // Send data every 30 seconds

// Pin Assignments
#define PIN_SOIL_MOISTURE 34 // ADC1_CH0 (VP) — Capacitive Soil Sensor
...
#define SOIL_DRY_VALUE 2637
#define SOIL_WET_VALUE 937
...
void setup() {
  Serial.begin(115200);
  Serial.println("\n=============================");
  Serial.println("  DEMETER GREENHOUSE  ");
